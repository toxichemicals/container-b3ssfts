...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-b3ssfts.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-b3ssfts.containers.anotherwebservice.com/
...
```
git clone git@github.com:toxichemicals/container-b3ssfts.git
cd container-b3ssfts
```
...
```
docker attach container-b3ssfts
```
